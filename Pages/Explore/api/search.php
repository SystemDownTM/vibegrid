...
try {
    ...
    $response = array();
    $text = base64_decode($data["TextSearch"]);
    if (is_dir("../../../Data/Users/" . md5($text) . "/") == true) {
        ...
        if ($query) {
            ...
            $response["UserT"] = htmlspecialchars($text);
            $response["UserPic"] = htmlspecialchars(file_get_contents("../../../Data/Users/" . md5($text) . "/Profile.txt"));
        }
    } else {
